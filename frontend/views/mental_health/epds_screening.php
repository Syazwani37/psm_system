...
<div class="container py-5" style="max-width: 800px;">
    ...
    <div class="d-flex align-items-center mb-4">
        <a href="<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/dashboard/mother.php" class="btn btn-outline-secondary me-3 rounded-circle shadow-sm" style="width: 45px; height: 45px; display: flex; align-items: center; justify-content: center;" title="Back to Dashboard">
...
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; displayFlashMessage(); ?>
    ...
    <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; if ($show_result): ?>
        <!-- Result View -->
        <div class="result-card">
            <div class="score-circle bg-<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $alert_color; ?>-custom">
                <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $total_score; ?>
            </div>
            
            <h2 class="mb-3">Result: <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $risk_level; ?> Risk</h2>
            <p class="lead text-muted mb-4"><?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $message; ?></p>

            <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; if ($risk_level == 'High' || $q10_score > 0): ?>
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-center mt-4">
                    <a href="<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/consultations/book.php" class="btn btn-danger btn-lg px-5 rounded-pill">
                        Book Consultation Now
                    </a>
                    <a href="<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/resources/support.php" class="btn btn-outline-danger btn-lg px-5 rounded-pill">
                        Find Support
                    </a>
                </div>
            <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; else: ?>
                <div class="d-grid gap-2 d-sm-flex justify-content-center mt-4">
                    <a href="<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/resources/articles.php" class="btn btn-success btn-lg px-5 rounded-pill">
                        Read Wellness Tips
                    </a>
                    <a href="<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $_SERVER['PHP_SELF']; ?>" class="btn btn-outline-secondary btn-lg px-5 rounded-pill">
                        Take Test Again
                    </a>
                </div>
            <?php
