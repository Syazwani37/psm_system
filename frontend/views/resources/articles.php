...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $link; ?>', '_blank')">
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $icon; ?>"></i></div>
                    <div class="article-content">
                        <h3><?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo escape($row['title']); ?></h3>
                        <p><?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo escape($row['description']); ?></p>
