...
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $stats['mothers']; ?></div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $stats['professionals']; ?></div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $stats['symptom_logs']; ?></div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $stats['pending_consultations']; ?></div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="d-flex flex-column gap-3">
                <a href="<?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/reports/recovery_trends.php" class="report-card text-decoration-none">
...
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $txt_recovery_update; ?></small>
                            </div>
                        </div>
                ...
                <a href="<?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/reports/user_engagement.php" class="report-card text-decoration-none">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex gap-3 align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $txt_user_update; ?></small>
                            </div>
                        </div>
                        <button class="btn btn-outline-secondary btn-sm">View Report</button>
                    </div>
                ...
                <a href="<?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/reports/nutrition.php" class="report-card text-decoration-none">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex gap-3 align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $txt_nutrition_update; ?></small>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card p-3">
                <div class="d-flex flex-column gap-3">
                    <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; if (empty($activity)): ?>
                        <p class="text-muted small mb-0">No recent activity.</p>
                    <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; else: ?>
                        <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; foreach($activity as $act): 
...
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $color; ?>; border-radius: 50%;"></div>
                            </div>
                            <div>
                                <div class="fw-bold small"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $title; ?></div>
                                <small class="text-muted"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $desc; ?></small>
                                <div class="text-primary small mt-1"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $timeStr; ?></div>
                            </div>
                        </div>
                        <?php
