...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo escape($userName); ?>! 👋
    ...
    <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/symptom_checker/index.php" class="feature-card mb-4" style="border: 1px solid #FFEBEE;">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/recovery/index.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/nutrition/index.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/consultations/book.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/community/index.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/resources/articles.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/mental_health/epds_screening.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/baby_growth/index.php" class="feature-card">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/journal/index.php" class="feature-card">
                <div class="feature-icon" style="background: #FFF3E0;">
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $tip['color_bg']; ?>; padding: 0.6rem; border-radius: 12px; color: <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $tip['color_text']; ?>; min-width: 45px; text-align: center;">
                                    <i class="fas <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $tip['icon']; ?>"></i>
                                </div>
                                <div>
                                    <h6 class="mb-1 fw-bold text-dark"><?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $tip['title']; ?></h6>
                                    <p class="text-secondary small mb-0" style="font-size: 0.85rem; line-height: 1.4;"><?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $tip['text']; ?></p>
                                </div>
                            </div>
                        </div>
                        <?php
