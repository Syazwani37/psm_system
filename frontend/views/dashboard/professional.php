        ...
        <div class="d-flex align-items-center gap-3">
            <div class="d-flex align-items-center gap-2 bg-white rounded-pill px-3 py-2 shadow-sm">
                <div style="width: 40px; height: 40px; background: #E0F7FA; color: #006064; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700;">
                    <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo getInitials($userName); ?>
                </div>
                <div>
                    <div class="fw-bold small"><?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo escape($userName); ?></div>
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo escape($userName); ?> 👋
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/patient_management/index.php" class="feature-card d-block">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/dashboard/analytics.php" class="feature-card d-block">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/resources/library.php" class="feature-card d-block">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/announcements/manage.php" class="feature-card d-block">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/consultations/manage.php" class="feature-card d-block">
...
function saveLogAction() {
    ...
    fetch('<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo BASE_URL; ?>/backend/api/symptom_checker/save_log_action.php', {
        method: 'POST',
        headers: {
