    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Patients',
                data: [<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $safe_count; ?>, <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $warning_count; ?>, <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $danger_count; ?>],
