    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Patients',
                data: [<?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $safe_count; ?>, <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $warning_count; ?>, <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $danger_count; ?>],
