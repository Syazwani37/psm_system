...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo date('Y-m-d'); ?>">
                        </div>
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $id; ?>">
                                <input type="hidden" name="milestone_name" value="<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $name; ?>">
                                <input type="checkbox" class="milestone-check" onchange="this.form.submit()" <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $is_done ? 'checked' : ''; ?>>
                                <span class="milestone-label <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo $is_done ? 'done' : ''; ?>" 
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            labels: <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo json_encode($dates); ?>,
            datasets: [{
                label: 'Weight (kg)',
                data: <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo json_encode($weights); ?>,
                borderColor: '#9575CD',
                ...
                label: 'Height (cm)',
                data: <?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/backend/config/database.php'; echo json_encode($heights); ?>,
                borderColor: '#26C6DA',
                borderDash: [5, 5],
                fill: false,
                tension: 0.4
