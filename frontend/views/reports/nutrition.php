...
<div class="page-container">
    <div class="text-center mb-5">
        <a href="<?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/views/dashboard/admin.php" class="btn btn-outline-secondary btn-sm mb-3">
...
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $adherence; ?>% (Based on log volume)</li>
            <li><i class="fas fa-check"></i> <strong>Most Active Period:</strong> Week <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $best_week_num; ?> Postpartum (<?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $best_week_val; ?>% of total logs)</li>
            <li><i class="fas fa-check"></i> <strong>Total Data Points:</strong> <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $count; ?> logs analyzed</li>
        </ul>

        <div class="percentage-bar">
            <div class="percentage-fill" style="width: <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $adherence; ?>%;"><?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo $adherence; ?>% Avg</div>
        </div>

        <div class="section-title"><i class="fas fa-lightbulb"></i> Recommendations</div>
        <ul class="report-list">
            <li><i class="fas fa-check"></i> <strong>Status:</strong> <?php
require_once dirname(__DIR__, 3) . '/backend/config/database.php'; echo ($adherence > 70) ? 'Excellent engagement levels.' : 'Encourage more daily logging.'; ?></li>
