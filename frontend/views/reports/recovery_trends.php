...
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $avg_temp > 0 ? $avg_temp . '°C' : 'No Data'; ?></span>
        </div>

        <div class="report-item">
            <span class="report-label">Patients Reporting High Pain (>3)</span>
            <span class="report-value"><?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $pain_percentage; ?>%</span>
        </div>

        <div class="report-item">
            <span class="report-label">Fatigue/Tiredness Reported</span>
            <span class="report-value"><?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $tired_percentage; ?>%</span>
        </div>

        <div class="report-item">
            <span class="report-label">Total Logs Analyzed</span>
            <span class="report-value"><?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $total_logs; ?></span>
        </div>
    </div>
