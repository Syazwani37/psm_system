...
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo ($save_status == 'success') ? 'block' : 'none'; ?>;">
...
<script>
<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; if ($save_status == 'success'): ?>
    const temp = <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $temp; ?>;
    const bleeding = "<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $bleeding; ?>";
    const pain = "<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $pain; ?>";
    const wound = "<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $wound; ?>";
    const mood = "<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $mood; ?>";
