...
<style>
    body {
        background: url('<?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo BASE_URL; ?>/frontend/assets/images/mom_and_baby_background.jpg') no-repeat center center/cover;
        min-height: 100vh;
        display: flex;
        align-items: center;
...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; if ($error): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="fas fa-exclamation-circle me-2"></i><?php
require_once dirname(__FILE__, 3) . '/backend/config/database.php'; echo $error; ?>
